"""
Django settings for zammer project.
...
SECRET_KEY = (
    "django-insecure-^#8612wf)ruxv*bpo++7zcc(2wah!2e@4*!lr)&!2-n3a3rrbh"
)
...
WSGI_APPLICATION = "zammer.wsgi.application"
